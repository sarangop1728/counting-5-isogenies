...
\begin{lemma}
    ...
    \begin{itemize}
        ...
        \begin{equation}
            ...
            \left(\Re((1-2i)^4 \cdot d), \Im((1-2i)^4 \cdot d), 5 \cdot \sqrt{d \overline{d}} \right)
            \end{cases},
        \end{equation}
        \item Suppose $l = 2$. Then the twist minimal triple $(a,b,c)$ is of the form
        \begin{equation}
            (a,b,c) = \left(\Re((1-2i)^{4k} \cdot d), \Im((1-2i)^{4k} \cdot d), 5^k \cdot \sqrt{d \overline{d}} \right)
        \end{equation}
        for any positive integer $k \geq 2$.
        \item Suppose $l = 3$. Then the twist minimal triple $(a,b,c)$ is of the form
        \begin{equation}
            (a,b,c) = \left(\Re(5 \cdot (1-2i)^{4k-2} \cdot d), \Im(5 \cdot (1-2i)^{4k-2} \cdot d), 5^k \cdot \sqrt{d \overline{d}} \right)
        \end{equation}
        for any positive integer $k \geq 2$.
    \end{itemize}
\end{lemma}
\begin{proof}
    ...
    \end{align*}
    Using the above equation, we obtain that the valuations of $41a + 38b$ and $278a + 29b$ with respect to $5$ are determined by the valuation of $a+bi$ with respect to $1-2i$. Because $(a,b,c)$ is a twist-minimal triple, $a^2 + b^2 = c^4$, and $5 \mid c$ from \ref{lemma:exceptional-triples}, we may write 5-exceptional triples $(a,b,c)$ as
    \begin{align*}
        a+bi = \begin{cases}
            (1-2i)^{4k} \cdot d \\
