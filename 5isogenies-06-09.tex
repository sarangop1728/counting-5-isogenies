...
\begin{lemma}
  ...
  where $\beta$ and $\delta$ coprime twist-minimal Gaussian integers, and
...
\begin{table}[ht]
    \begin{tabular}{|c|c|}
      ...
      $1$   & $5(1\pm 2i)^2, (1\pm 2i)^4$              \\ \hline
      $2$   & $(1\pm 2i)^{4k}$                         \\ \hline
      $3$   & $5(1\pm 2i)^{4k-2}$                      \\ \hline
    \end{tabular}
...
\begin{proof}
  ...
  \end{align*}
  Taking $\ord_5(\cdot)$ on \Cref{eq:A,eq:B} we obtain
  \begin{align}
    \label{eq:ord-5-A}
    \ord_5(A(a,b,c)) \geq \min\brk{\ord_5((1+2i)^5\beta), 3+2k}, \\
    \label{eq:ord-5-B}
    \ord_5(B(a,b,c)) \geq \min\brk{\ord_5((1+2i)^7\beta), 4+2k},
  \end{align}
